...
public class SearchController {
    ...
    public ResponseEntity findMenCategory(@RequestParam int page){
        Page<ItemResponseDto> menItem = itemService.findMenItem(page - 1, 10);
        PageInfo pageInfo = new PageInfo(page, 5,(int)menItem.getTotalElements(), menItem.getTotalPages());
    ...
    public ResponseEntity findWomenCategory(@RequestParam int page){
        Page<ItemResponseDto> womenItem = itemService.findWomenItem(page - 1, 10);
        PageInfo pageInfo = new PageInfo(page, 5,(int)womenItem.getTotalElements(), womenItem.getTotalPages());
    ...
    public ResponseEntity findTopCategory(@RequestParam int page){
        Page<ItemResponseDto> topItem = itemService.findTopItem(page - 1, 10);
        PageInfo pageInfo = new PageInfo(page, 5,(int)topItem.getTotalElements(), topItem.getTotalPages());
    ...
    public ResponseEntity findBottomCategory(@RequestParam int page){
        Page<ItemResponseDto> bottomItem = itemService.findBottomItem( page - 1, 10);
        PageInfo pageInfo = new PageInfo(page, 5,(int)bottomItem.getTotalElements(), bottomItem.getTotalPages());
    ...
    public ResponseEntity search(@RequestParam("content") String content, @RequestParam int page) {
        Page<ItemResponseDto> searchItem = itemService.findSearchItem(content, page - 1, 10);
        PageInfo pageInfo = new PageInfo(page, 5,(int)searchItem.getTotalElements(), searchItem.getTotalPages());
